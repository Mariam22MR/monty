...
void swap_two_elements(stack_t **, unsigned int);
void add_two_elements(stack_t **, unsigned int);
void sub_two_elements(stack_t **, unsigned int);
void div_two_elements(stack_t **, unsigned int);
void mul_two_elements(stack_t **, unsigned int);
void mod_two_elements(stack_t **, unsigned int);
